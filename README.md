...
Testing deployment on Google cloud run
...
**Logs:**
- GKE: `kubectl logs -l app=test-app-cloudrun -n default`
...
**Generated by Backstage IDP** - test-app-cloudrun
...
- **GitHub Repository:** [View on GitHub](https://github.com/group:default/developers/test-app-cloudrun)
