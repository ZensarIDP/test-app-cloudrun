...
app.get('/', (req, res) => {
  res.json({
    message: 'Welcome to test-app-cloudrun!',
    description: 'Testing deployment on Google cloud run',
    version: '1.0.0',
    environment: process.env.NODE_ENV || 'development',
    endpoints: {
      health: '/health',
...
app.listen(port, () => {
  console.log('🚀 test-app-cloudrun is running on port ' + port);
